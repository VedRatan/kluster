...
import (
	...
	vedratandevv1alpha1 "github.com/VedRatan/kluster/pkg/apis/vedratan.dev/v1alpha1"
	versioned "github.com/VedRatan/kluster/pkg/client/clientset/versioned"
	internalinterfaces "github.com/VedRatan/kluster/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/VedRatan/kluster/pkg/client/listers/vedratan.dev/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.VedratanV1alpha1().Klusters(namespace).List(context.TODO(),options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.VedratanV1alpha1().Klusters(namespace).Watch(context.TODO(), options)
			},
		},
		&vedratandevv1alpha1.Kluster{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *klusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&vedratandevv1alpha1.Kluster{}, f.defaultInformer)
}
